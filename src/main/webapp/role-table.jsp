                            ...
                            <table class="table" id="example">
                                ...
                                <c:forEach items="${roles}" var="role">
                                    <tr>
                                        ...
                                        <td>
                                            <a href='http://localhost:8081/crm/api/user?id=${role.getId()}' class="btn btn-sm btn-primary
                                               btn-update" data-toggle="modal"
                                               data-target="#modelId" roleId="${role.getId()}" >Sửa</a>
                                            <a href="#" class="btn btn-sm btn-danger btn-delete" roleId="${role.getId()}">Xóa</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
