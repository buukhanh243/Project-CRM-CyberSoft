        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form class="form-horizontal form-material" action="http://localhost:8081/crm/user"
                              id="frmAccount" method="post">
                            <input type="hidden" id="account_id" name="account_id">
                            <div class="form-group">
                                <label class="col-md-12">Full Name</label>
                                <div class="col-md-12">
                                    <input type="text" placeholder="Johnathan Doe" id="fullname"
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success" href='<c:url value="/user"></c:url>' type="submit">Add User</button>
